...
public class AbstractLogAdapterTestCase {
    ...
    public void testToMessageBeforeNoArgs() throws Exception {
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(new BitSet(), null);
    ...
    public void testToMessageBeforeOneArg() throws Exception {
        ...
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(arNames, true);
    ...
    public void testToMessageBeforeOneArgNoName() throws Exception {
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(null, true);
        Object message = logAdapter.toMessage("fooMethod", new Object[]{"v1"}, descriptor);
    ...
    public void testToMessageBeforeSomeArgs() throws Exception {
        ...
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(arNames, false, true);
    ...
    public void testToMessageBeforeSomeArgsNoNames() throws Exception {
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(null, false, true);
        Object message = logAdapter.toMessage("fooMethod", new Object[]{"v1", "v2"}, descriptor);
    ...
    public void testToMessageBeforeAllArgs() throws Exception {
        String[] arNames = {"first", "second"};
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(arNames, true, true);
        Object message = logAdapter.toMessage("fooMethod", new Object[]{"v1", "v2"}, descriptor);
    ...
    public void testToMessageBeforeAllArgsNoNames() throws Exception {
        ArgumentDescriptor descriptor = TestSupportUtility.createArgumentDescriptor(null, true, true);
        Object message = logAdapter.toMessage("fooMethod", new Object[]{"v1", "v2"}, descriptor);
